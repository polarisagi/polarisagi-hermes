...
func handleAnthropicNonStreamResponse(w http.ResponseWriter, vertexResp *http.Response, req MessageRequest, traceID string, ch *channel.ActiveChannel, clientType, modelName string, reqBody []byte, isCompact bool) {
